// Conversation scenarios + free-chat configs for Glossa
//
// Each scenario has:
//   - id, title, nativeTitle, glyph (a single-letter typographic placeholder)
//   - blurb (card excerpt)
//   - setting (one-line context shown at start of chat)
//   - opener (the model's first turn — emitted by the harness, not the model,
//             so the conversation starts immediately even before the engine
//             has fully warmed up)
//   - starters (3-4 short suggestions the learner can tap to send)
//   - goal (success condition, baked into system prompt)
//   - systemFor(level) → system prompt for the chosen CEFR level
//
// Free-chat modes use a similar shape with no scenario goal.
...
// Rules that apply to every chat mode. Repeated and bolded so a small model
// has a fighting chance of following them.
const CORE_RULES = [
...
function buildFreeSystem(mode, langName, level) {
  const cefr = CEFR_GUIDE[level] || CEFR_GUIDE.A2;
  if (mode === "crosstalk") {
    return [
      ...
      `${CORE_RULES.length + 1}. The translation you give is of YOUR OWN ${langName} reply — NOT a translation of the learner's English message. The learner already knows English; they do not need their own message translated.`,
      "",
      "=== REPLY FORMAT (exact) ===",
      ...
      `• Put the ${langName} block FIRST.`,
      "• Then a line containing ONLY three dashes: ---",
      "• Then the English translation block.",
      `• NEVER put English inside the ${langName} block. NEVER use parentheses for translation. NEVER label the blocks (no "EN:", no "GR:").`,
      "• No other text before, between, or after the two blocks.",
      "",
      "=== WORKED EXAMPLES ===",
      "Learner: \"I had a really long day at work.\"",
      "You reply:",
      langName === "Greek"
        ? "Αχ, καταλαβαίνω. Τι δουλειά κάνεις;"
        : "Ay, te entiendo. ¿A qué te dedicas?",
      "---",
      langName === "Greek"
        ? "Oh, I understand. What kind of work do you do?"
        : "Ah, I understand. What do you do (for work)?",
      "",
      "Learner: \"I love hiking on the weekends.\"",
      "You reply:",
      langName === "Greek"
        ? "Ωραία! Πού πας συνήθως για πεζοπορία;"
        : "¡Qué bien! ¿A dónde sueles ir de senderismo?",
      "---",
      langName === "Greek"
        ? "Lovely! Where do you usually go hiking?"
        : "How nice! Where do you usually go hiking?",
      "",
      "Now begin the conversation. The learner will write next — follow the format above EXACTLY.",
    ].join("\n");
  }
  // "normal"
  return [
    ...
    "=== WORKED EXAMPLES ===",
    langName === "Greek" ? [
      'Learner: "Είμαι κουρασμένος σήμερα."',
      'You reply: "Ω, κρίμα! Γιατί; Δούλεψες πολύ;"',
      "",
      'Learner: "Μου αρέσει η θάλασσα."',
      'You reply: "Κι εμένα! Ποια θάλασσα προτιμάς εσύ;"',
    ].join("\n") : [
      'Learner: "Hoy estoy muy cansado."',
      'You reply: "¡Vaya! ¿Por qué? ¿Trabajaste mucho?"',
      "",
      'Learner: "Me encanta el mar."',
      'You reply: "¡A mí también! ¿Qué playa prefieres?"',
    ].join("\n"),
    "",
    ...
    A1: [
      {
        ...
        nativeTitle: "Παραγγέλνοντας καφέ",
        glyph: "Κ",
      ...
      },
      {
        ...
        nativeTitle: "Check-in στο ξενοδοχείο",
        glyph: "Ξ",
      ...
      },
      {
        ...
        goal: "The learner asks for directions to a specific place and confirms they understood (repeats back left/right/straight, or thanks them and walks off in a direction).",
    ...
    A2: [
      {
        ...
        goal: "The learner describes at least one symptom, accepts or asks about a recommendation, and pays (or asks the price).",
      ...
      {
        id: "g-a2-ferry",
        title: "Buying a ferry ticket",
        nativeTitle: "Αγοράζοντας εισιτήριο πλοίου",
        glyph: "Π",
        ...
        goal: "The learner buys a ferry ticket to a specific island for a specific day, confirms the time, and asks one practical question (luggage, deck class, return).",
      ...
      },
      {
        ...
        nativeTitle: "Νοικιάζοντας διαμέρισμα",
        glyph: "Δ",
        ...
        goal: "The learner asks at least two questions about the flat (price, bills, neighbours, heating, length of lease, pets) and gives a clear yes/no/maybe at the end.",
    ...
    B1: [
      {
        ...
        nativeTitle: "Παράπονο στο εστιατόριο",
        glyph: "Ε",
        ...
        goal: "The learner clearly states the problem, accepts a fair resolution (replacement, discount, or apology), and the situation is resolved politely.",
      ...
      {
        id: "g-b1-interview",
        title: "A casual job interview",
        nativeTitle: "Συνέντευξη για δουλειά",
        glyph: "Β",
  ...
  spanish: {
    A1: [
      ...
      },
      {
        id: "s-a1-hotel",
        title: "Hotel check-in",
        nativeTitle: "Check-in en el hotel",
        glyph: "H",
      ...
      {
        id: "s-a1-introductions",
        title: "Meeting your host",
        nativeTitle: "Conociendo a tu anfitriona",
        glyph: "A",
        ...
        goal: "The learner says their name and where they're from, answers one personal question (family, work, hobbies), and asks one question back.",
    ...
    A2: [
      {
        ...
        goal: "The learner describes at least one symptom, says how long it has lasted, and accepts a recommendation (rest, medicine, a test).",
      ...
      },
      {
        ...
        nativeTitle: "Comprando un billete de tren",
        glyph: "T",
        ...
        goal: "The learner buys a train ticket to a specific city for a specific day, chooses one or two preferences (class, seat, time), and asks one question.",
        starters: ["Quería un billete a Sevilla.", "Para el viernes que viene.", "¿A qué hora sale?", "¿Cuánto tarda?"],
        opener: "Hola, ¿adónde viaja?",
      },
      {
        id: "s-a2-roommate",
        title: "Meeting a flatmate",
        nativeTitle: "Conociendo a un compañero de piso",
        glyph: "P",
        ...
        goal: "The learner answers basic questions (work, hours, habits), asks at least one question about the flat, and the conversation ends with a clear next step (yes/no/think about it).",
    ...
    B1: [
      {
        ...
        nativeTitle: "Devolviendo un producto",
        glyph: "T",
        ...
        goal: "The learner clearly explains the problem, shows or mentions the receipt, and reaches a resolution (refund, exchange, or repair).",
      ...
      {
        id: "s-b1-debate",
        title: "Friendly debate over dinner",
        nativeTitle: "Discutiendo en la cena",
        glyph: "Ñ",
    ...
    B2: [
      {
        ...
        nativeTitle: "Una entrevista de trabajo",
        glyph: "J",
...
// Free chat modes — appear at the bottom of the landing page
const FREE_MODES = [
  {
    id: "normal",
    title: "Free chat",
    ...
    opener: {
      greek: "Γεια σου! Πώς ήταν η μέρα σου;",
      spanish: "¡Hola! ¿Qué tal el día?",
    },
    starters: {
