export type LessonStatus = 'done' | 'current' | 'next' | 'locked';
export type LevelCode = 'A1' | 'A2' | 'B1' | 'B2' | 'C1' | 'C2';

export interface Lesson { title: string; desc: string; status: LessonStatus; }
export interface Unit { id: string; title: string; subtitle: string; lessons: Lesson[]; }
export interface Course { name: string; native: string; flag: string; levels: LevelCode[]; units: Partial<Record<LevelCode, Unit[]>>; }

export const COURSES: Record<string, Course> = {
  greek: {
    name: 'Greek', native: 'Ελληνικά', flag: 'GR', levels: ['A1', 'A2', 'B1'],
    units: {
      A1: [
        { id: 'g-a1-1', title: 'First Words', subtitle: 'Greetings, introductions, the alphabet', lessons: [
        ...
        { id: 'g-a1-2', title: 'People & Family', subtitle: 'Pronouns, family members, possession', lessons: [
        ...
        { id: 'g-a1-3', title: 'Numbers, Days, Time', subtitle: 'Counting, telling time, scheduling', lessons: [
        ...
        { id: 'g-a1-4', title: 'At the Taverna', subtitle: 'Food, ordering, polite requests', lessons: [
        ...
        { id: 'g-a1-5', title: 'Around the Neighborhood', subtitle: 'Places, directions, prepositions', lessons: [
        ...
        { id: 'g-a1-6', title: 'A Day in My Life', subtitle: 'Routines, present tense, frequency', lessons: [
      ...
      A2: [
        { id: 'g-a2-1', title: 'Past Adventures', subtitle: 'Past tense, storytelling, time markers', lessons: [
        ...
        { id: 'g-a2-2', title: 'Travel & Transport', subtitle: 'Tickets, schedules, the ferry to the islands', lessons: [
        ...
        { id: 'g-a2-3', title: 'Health & Body', subtitle: 'At the doctor, feelings, advice', lessons: [
      ...
      B1: [
        { id: 'g-b1-1', title: 'Opinions & Debates', subtitle: 'Expressing views, agreeing, disagreeing', lessons: [
  ...
  spanish: {
    name: 'Spanish', native: 'Español', flag: 'ES', levels: ['A1', 'A2', 'B1', 'B2'],
    units: {
      A1: [
        { id: 's-a1-1', title: 'Hola, mucho gusto', subtitle: 'Greetings, names, basic questions', lessons: [
        ...
        { id: 's-a1-2', title: 'Mi familia', subtitle: 'Family, possessives, ser vs. estar', lessons: [
        ...
        { id: 's-a1-3', title: 'En el café', subtitle: 'Ordering food and drinks', lessons: [
        ...
        { id: 's-a1-4', title: 'La ciudad', subtitle: 'Places, directions, prepositions', lessons: [
        ...
        { id: 's-a1-5', title: 'Mi día', subtitle: 'Daily routine, present tense, time', lessons: [
      ...
      A2: [
        { id: 's-a2-1', title: 'Recuerdos', subtitle: 'Imperfect tense, childhood memories', lessons: [
        ...
        { id: 's-a2-2', title: 'De viaje', subtitle: 'Travel, hotels, asking for help', lessons: [
      ...
      B1: [
        { id: 's-b1-1', title: 'Opiniones', subtitle: 'Subjunctive, expressing wishes', lessons: [
      ...
      B2: [
        { id: 's-b2-1', title: 'Cine y literatura', subtitle: 'Cultural commentary, advanced narration', lessons: [
...
export const LANGUAGE_LIST = Object.entries(COURSES).map(([id, c]) => ({
  id, name: c.name, native: c.native, flag: c.flag,
}));
