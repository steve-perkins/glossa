export interface Paragraph { t: string; e: string; }
export interface Story {
  id: string; title: string; nativeTitle: string; glyph: string;
  minutes: number; words: number; excerpt: string; read: boolean;
  paragraphs: Paragraph[];
}

export const STORIES: Record<string, Partial<Record<string, Story[]>>> = {
  greek: {
    A1: [
      { id: 'g-a1-prwino', title: 'My Morning', nativeTitle: 'Το πρωινό μου', glyph: 'Π', minutes: 3, words: 78,
        excerpt: 'Nikos lives in Athens. Every morning he drinks coffee on the balcony.', read: true,
        paragraphs: [
      ...
      { id: 'g-a1-kafe', title: 'A Coffee in Exarcheia', nativeTitle: 'Ένας καφές στα Εξάρχεια', glyph: 'Κ', minutes: 2, words: 64,
        excerpt: 'Maria meets a friend at a small café and orders a freddo.', read: true,
        paragraphs: [
      ...
      { id: 'g-a1-gata', title: 'The Cat on the Roof', nativeTitle: 'Η γάτα στη στέγη', glyph: 'Γ', minutes: 2, words: 58,
        excerpt: 'A small cat has a problem and a kind neighbour helps.', read: false,
        paragraphs: [
      ...
      { id: 'g-a1-laiki', title: 'Saturday at the Market', nativeTitle: 'Σάββατο στη λαϊκή', glyph: 'Λ', minutes: 3, words: 82,
        excerpt: 'Yiannis shops for fresh tomatoes, oranges and a friendly chat.', read: false,
        paragraphs: [
    ...
    A2: [
      { id: 'g-a2-nisi', title: 'A Letter from the Island', nativeTitle: 'Ένα γράμμα από το νησί', glyph: 'Ν', minutes: 4, words: 124,
        excerpt: 'Eleni writes to her sister about her first week on Sifnos.', read: true,
        paragraphs: [
      ...
      { id: 'g-a2-treno', title: 'The Last Train', nativeTitle: 'Το τελευταίο τρένο', glyph: 'Τ', minutes: 4, words: 138,
        excerpt: 'Andreas almost misses the train back to Thessaloniki and meets an old friend.', read: false,
        paragraphs: [
      ...
      { id: 'g-a2-vivlio', title: 'The Forgotten Book', nativeTitle: 'Το ξεχασμένο βιβλίο', glyph: 'Β', minutes: 3, words: 96,
        excerpt: 'Sofia finds a book on a park bench with a curious note inside.', read: false,
        paragraphs: [
    ...
    B1: [
      { id: 'g-b1-zaxaroplasteio', title: 'The Pastry Shop on the Corner', nativeTitle: 'Το ζαχαροπλαστείο της γωνίας', glyph: 'Ζ', minutes: 6, words: 192,
        excerpt: 'Three generations of a Thessaloniki family have run the same bougatsa shop.', read: false,
        paragraphs: [
      ...
      { id: 'g-b1-thalassa', title: 'The Sea Remembers', nativeTitle: 'Η θάλασσα θυμάται', glyph: 'Θ', minutes: 5, words: 168,
        excerpt: 'An old fisherman talks about how the sea has changed, and what stays the same.', read: false,
        paragraphs: [
  ...
  spanish: {
    A1: [
      { id: 's-a1-cafe', title: 'Coffee with Grandma', nativeTitle: 'Un café con la abuela', glyph: 'C', minutes: 2, words: 72,
        excerpt: 'Every Sunday Lucía visits her grandmother for coffee and stories.', read: true,
        paragraphs: [
      ...
      { id: 's-a1-perro', title: 'The Dog and the Beach', nativeTitle: 'El perro y la playa', glyph: 'P', minutes: 2, words: 60,
        excerpt: "Pablo's dog Toby is afraid of the waves — until he isn't.", read: false,
        paragraphs: [
      ...
      { id: 's-a1-mercado', title: 'At the Market', nativeTitle: 'En el mercado', glyph: 'M', minutes: 3, words: 88,
        excerpt: 'Carmen buys tomatoes, asks for advice, and learns a new recipe.', read: false,
        paragraphs: [
      ...
      { id: 's-a1-lluvia', title: 'A Rainy Afternoon', nativeTitle: 'Una tarde de lluvia', glyph: 'Ll', minutes: 2, words: 70,
        excerpt: 'Two friends stay inside, drink chocolate and play cards.', read: false,
        paragraphs: [
    ...
    A2: [
      { id: 's-a2-tren', title: 'The Night Train', nativeTitle: 'El tren nocturno', glyph: 'T', minutes: 4, words: 132,
        excerpt: 'A long train ride from Madrid to Lisbon, and an unexpected conversation.', read: false,
        paragraphs: [
      ...
      { id: 's-a2-vecino', title: 'The New Neighbour', nativeTitle: 'El nuevo vecino', glyph: 'V', minutes: 3, words: 110,
        excerpt: 'Someone moves into the empty flat upstairs, and the building starts to change.', read: false,
        paragraphs: [
    ...
    B1: [
      { id: 's-b1-libreria', title: 'The Bookshop Without a Name', nativeTitle: 'La librería sin nombre', glyph: 'L', minutes: 5, words: 178,
        excerpt: 'A bookshop in Granada with no sign, no name, and the right book for every visitor.', read: false,
        paragraphs: [
      ...
      { id: 's-b1-tortilla', title: 'A Debate About Tortilla', nativeTitle: 'Una discusión sobre la tortilla', glyph: 'Ñ', minutes: 4, words: 156,
        excerpt: 'Two friends will never agree on whether the perfect tortilla has onion.', read: false,
        paragraphs: [
    ...
    B2: [
      { id: 's-b2-cine', title: 'An Old Cinema', nativeTitle: 'Un cine antiguo', glyph: 'C', minutes: 6, words: 214,
        excerpt: 'The reopening of a neighbourhood cinema, and what we lose when these places disappear.', read: false,
        paragraphs: [
